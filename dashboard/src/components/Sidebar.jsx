...
const Sidebar = () => {
  return (
    <div className='bg-[#003a10] min-h-screen pl-[4vw]'>
        <img className='mt-5 w-[max(10vw,100px)] mr-5 hidden sm:block' src={assets.logo} alt="" />
        <img className='mt-5 w-[max(5vw,40px)] mr-5 block  sm:hidden' src={assets.logo_small} alt="" />
